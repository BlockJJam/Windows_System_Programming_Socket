...
void _tmain(int argc, _TCHAR* argv[])
{
	...
	(
		argv[1], GENERIC_READ, 0, NULL, OPEN_EXISTING, FILE_FLAG_SEQUENTIAL_SCAN, NULL
	);
	...
	LPFN_TRANSMITFILE pfnTransFile = (LPFN_TRANSMITFILE)GetSockExtAPI(sock, WSAID_TRANSMITFILE);
